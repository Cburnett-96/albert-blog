<%@ Page Title="Terms and Conditions" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TermsAndConditions.aspx.cs" Inherits="myblog.Terms_Condotions" EnableEventValidation="false" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to AlbertzZ.</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p><strong>Website</strong> refers to AlbertzZ, accessible from <a href="http://AlbertzZ.somee.com" rel="external nofollow noopener" target="_blank">http://AlbertzZ.somee.com</a></p>
                            </li>
                            <li>
...
You agree that the original English text shall prevail in the case of a dispute.
                        ...
                        <ul>
                            <li>
                                <p>By email: albert.pasco@lspu.edu.ph</p>
                            </li>
                            <li>
                                <p>By phone number: +639360276388</p>
                            </li>
                        </ul>
                    </div>
                                ...
                                <ul class="cat-list mt-0">
                                    <li>
                                        <a href="../Category/Post_My Photography.aspx" class="d-flex justify-content-between">
                                            <p>My Photography </p><asp:Label ID="lblMyPhotography" runat="server"></asp:Label>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="../Category/Post_Anime Recommendations.aspx" class="d-flex justify-content-between">
                                            <p>Anime Recommendations </p><asp:Label ID="lblAnimeRecom" runat="server"></asp:Label>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="../Category/Post_Simple Program.aspx" class="d-flex justify-content-between">
                                            <p>Simple Program </p><asp:Label ID="lblSimpleProg" runat="server"></asp:Label>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="../Category/Post_Course Project Systems.aspx" class="d-flex justify-content-between">
                                            <p>My Course/School Project Systems </p><asp:Label ID="lblCourse" runat="server"></asp:Label>
                                        </a>
                                    </li>
                                    <li>
