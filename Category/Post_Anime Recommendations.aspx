<%@ Page Title="Anime Contents" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Post_Anime Recommendations.aspx.cs" Inherits="myblog.Category.Post_AnimeRecommendations" EnableEventValidation="false" %>
    ...
    <form runat="server">
        ...
        <div class="row">
            <div class="col-lg-3 myfootershare">
                <img class="img-fluid" src="https://add.pics/images/2021/04/02/left_top.png" />
            </div>
            <div class="col-lg-6">
                <center>
                 <h6>You are Browsing To</h6>
                   <h1>Anime Contents</h1>
            </center>
            </div>
            <div class="col-lg-3 myfootershare">
                <img class="img-fluid" src="https://add.pics/images/2021/04/02/right_top.png" />
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3 myfootershare">
                <img class="img-fluid" src="https://add.pics/images/2021/04/02/left_bottom.png" />
            </div>
            <div class="col-lg-6">
                <center>
                    <h1>Thank You</h1>
            ...
            <div class="col-lg-3 myfootershare">
                <img class="img-fluid" src="https://add.pics/images/2021/04/02/right_bottom.png" />
            </div>
        </div>
    </form>
</asp:Content>
