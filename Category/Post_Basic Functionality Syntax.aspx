<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Post_Basic Functionality Syntax.aspx.cs" Inherits="myblog.Category.Post_Basic_Functionality_Syntax" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form runat="server">
                <center>
                 <h6>You are Browsing To</h6>
                   <h1>Basic Functionality Syntax</h1>
            </center>
