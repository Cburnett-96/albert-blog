<%@ Page Title="Miscellaneous" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Post_Miscellaneous.aspx.cs" Inherits="myblog.Category.Miscellaneous" EnableEventValidation="false" %>
                    ...
                    <div class="col-lg-8">
                        <div class="single-amenities">
                            <asp:Repeater ID="Repeater1" runat="server">
                                <ItemTemplate>
                                    <div class="row">
                                        <div class="col-sm-6 col-sm-6 amenities-thumb">
