<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Post_Tweaks Troubleshooting PC.aspx.cs" Inherits="myblog.Category.Post_Tweaks_Troubleshooting_PC" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <form runat="server">
                <center>
                 <h6>You are Browsing To</h6>
                   <h1>Tweak & Troubleshooting PC</h1>
            </center>
